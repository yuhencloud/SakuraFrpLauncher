    ...
    m_log_text_edit(nullptr)
{
    ...
    this->setWindowTitle(QString::fromLocal8Bit("查看日志"));
...
void SFLLogDlg::UpdateLog(
    ...
    m_info_label->setText(QString::fromLocal8Bit("隧道ID:") + QString::number(tunnel_process.tunnel_item_info.tunnel_id) + "\t" + QString::fromLocal8Bit("隧道：") + tunnel_process.tunnel_item_info.tunnel_name);
